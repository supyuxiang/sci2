...
# 初始化SwanLab
run = init_swanlab("rf_model.py")

print("="*60)
print("Random Forest Regression Temperature Prediction Analysis")
print("="*60)
...
fig.suptitle('Random Forest Regression Temperature Prediction Analysis Results', fontsize=16, fontweight='bold')
...
# 多个评估指标
cv_mae = cross_val_score(rf_model, X, y, cv=kfold, scoring='neg_mean_absolute_error')
