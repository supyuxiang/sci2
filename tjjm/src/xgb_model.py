...
# 初始化SwanLab
run = init_swanlab("xgb_model.py")

print("="*60)
print("XGBoost Regression Temperature Prediction Analysis")
print("="*60)
...
# 模型训练
print("\nStarting XGBoost Regression model training...")
...
fig.suptitle('XGBoost Regression Temperature Prediction Analysis Results', fontsize=16, fontweight='bold')
...
# 多个评估指标
cv_mae = cross_val_score(xgb_model, X, y, cv=kfold, scoring='neg_mean_absolute_error')
cv_rmse = cross_val_score(xgb_model, X, y, cv=kfold, scoring='neg_root_mean_squared_error')
cv_r2 = cross_val_score(xgb_model, X, y, cv=kfold, scoring='r2')
...
print(f"\nXGBoost Regression Model Parameters:")
