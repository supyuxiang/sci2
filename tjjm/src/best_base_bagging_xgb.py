...
results_dir = "../results/best_base_bagging_xgb"
...
print("="*60)
print("XGBoost Best Base Model with Bagging Optimization Analysis")
print("="*60)
...
print("\nStarting XGBoost base model hyperparameter optimization...")
...
plt.title('XGBoost Parameter Optimization Process (MAE vs n_estimators)', fontsize=14)
...
for n_bagging in range(1, 21):  # Testing from 1 to 20 base models
...
plt.ylabel('MAE', fontsize=12)
plt.title('XGBoost Bagging Model Optimization (MAE vs Number of Models)', fontsize=14)
plt.grid(True, linestyle='--', alpha=0.7)
plt.legend()
...
fig.suptitle('XGBoost Best Base Model with Bagging Optimization Results', fontsize=16, fontweight='bold')
