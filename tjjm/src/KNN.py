...
# 初始化SwanLab
run = init_swanlab("KNN.py")

print("="*60)
print("K-Nearest Neighbors Regression Temperature Prediction Analysis")
print("="*60)
...
# 模型训练
print("\nStarting K-Nearest Neighbors Regression model training...")
...
fig.suptitle('K-Nearest Neighbors Regression Temperature Prediction Analysis Results', fontsize=16, fontweight='bold')
...
# 多个评估指标
cv_mae = cross_val_score(knn_model, X, y, cv=kfold, scoring='neg_mean_absolute_error')
...
print(f"\nK-Nearest Neighbors Regression Model Parameters:")
